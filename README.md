...
- network_proximity: calculating the relative average shortest distance between the drug targets and disease onset clusters, input files are ‘drug_target.txt’ and ‘cluster1-8.txt’ in ‘cluster_genes.zip’. Note: Using Python 2.7.
