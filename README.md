...
- network_proximity: calculating the relative average shortest distance between the drug targets and disease onset clusters, input files are ‘drug_targets.txt’ and ‘cluster.txt’.
